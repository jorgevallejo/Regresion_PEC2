...
Finalmente, una forma rápida de buscar anómalos y valores ausentes es mediante el resumen numérico:
```{r}
summary(diabetes)
```
...
A primera vista, las correlaciones más obvias son _cintura-cadera_, _cintura-peso_ y _cadera-peso_. Nada sorprendente. Otra correlación que parece clara es _bp.1s-bp.1d_. Correlaciones más difusas podrían ser _altura-peso_, _glyhb-stab.glu_, _chol-stab.glu_ y _chol-hdl_.
